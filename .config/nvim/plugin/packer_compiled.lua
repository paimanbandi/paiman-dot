...
_G.packer_plugins = {
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/Users/paiman/.local/share/nvim/site/pack/packer/start/cmp-tabnine"
  },
  ["dart-vim-plugin"] = {
    loaded = true,
  ...
  ["format.nvim"] = {
    loaded = true,
    path = "/Users/paiman/.local/share/nvim/site/pack/packer/start/format.nvim"
  },
  ...
  nerdcommenter = {
    loaded = true,
    path = "/Users/paiman/.local/share/nvim/site/pack/packer/start/nerdcommenter"
  },
  ["nvim-autopairs"] = {
    loaded = true,
  ...
  ["trouble.nvim"] = {
    ...
    loaded = true,
    path = "/Users/paiman/.local/share/nvim/site/pack/packer/start/trouble.nvim"
  },
  ["vim-illuminate"] = {
    loaded = true,
